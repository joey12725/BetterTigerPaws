import { AbstractInterpretPredictionsProvider } from '@aws-amplify/predictions/lib-esm/types/Providers';
import { InterpretTextInput, InterpretTextOutput } from '@aws-amplify/predictions/lib-esm/types';

import { AbstractIdentifyPredictionsProvider } from '@aws-amplify/predictions/lib-esm/types/Providers';
import { IdentifyLabelsInput, IdentifyLabelsOutput, IdentifyEntitiesInput, IdentifyEntitiesOutput, IdentifyTextInput, IdentifyTextOutput } from '@aws-amplify/predictions/lib-esm/types';

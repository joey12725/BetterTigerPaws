import { ModelPredicate, PersistentModel, PredicatesGroup, ProducerModelPredicate, SchemaModel } from '@aws-amplify/datastore/lib-esm/types';
export { ModelSortPredicateCreator } from '@aws-amplify/datastore/lib-esm/predicates/sort';
...
export declare class ModelPredicateCreator {
     ...
     */
    static createFromFlatEqualities<T extends PersistentModel>(modelDefinition: SchemaModel, flatEqualities: Record<string, any>): ModelPredicate<any>;
    /**

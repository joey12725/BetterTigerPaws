import { Place, GeoConfig, Coordinates, SearchByTextOptions, SearchByCoordinatesOptions, GeoProvider, MapStyle, GeofenceId, GeofenceInput, GeofenceOptions, SaveGeofencesResults, Geofence, ListGeofenceOptions, ListGeofenceResults, DeleteGeofencesResults, searchByPlaceIdOptions } from '@aws-amplify/geo/lib-esm/types';
export declare class GeoClass {
     ...
     */
    searchForSuggestions(text: string, options?: SearchByTextOptions): Promise<import("@aws-amplify/geo/lib-esm/types").SearchForSuggestionsResults>;
    /**

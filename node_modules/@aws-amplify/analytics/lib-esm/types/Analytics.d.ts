...
export { PersonalizeAnalyticsEvent } from '@aws-amplify/analytics/lib-esm/types/Providers/AmazonPersonalizeProvider';
export { KinesisAnalyticsEvent } from '@aws-amplify/analytics/lib-esm/types/Providers/AWSKinesisProvider';

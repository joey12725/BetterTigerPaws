import { AnalyticsProvider, AnalyticsEvent, AutoTrackSessionOpts, AutoTrackPageViewOpts, AutoTrackEventOpts, PersonalizeAnalyticsEvent, KinesisAnalyticsEvent } from '@aws-amplify/analytics/lib-esm/types';
import { PageViewTracker, EventTracker, SessionTracker } from '@aws-amplify/analytics/lib-esm/trackers';

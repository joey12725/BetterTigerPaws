import { ValidationError } from '@aws-amplify/ui/dist/types/types/authenticator/validator';
import { AuthFormData, AuthFormFields } from '@aws-amplify/ui/dist/types/types/authenticator/form';
import { AuthChallengeName, AmplifyUser, UnverifiedContactMethods } from '@aws-amplify/ui/dist/types/types/authenticator/user';
import { CodeDeliveryDetails as CognitoCodeDeliveryDetails } from 'amazon-cognito-identity-js';
import { LoginMechanism, SignUpAttribute, SocialProvider } from '@aws-amplify/ui/dist/types/types/authenticator/attributes';
import { defaultServices } from '@aws-amplify/ui/dist/types/machines/authenticator/defaultServices';
import { PasswordSettings } from '@aws-amplify/ui/dist/types/types/authenticator';
/**

import { PartialDeep } from '@aws-amplify/ui/dist/types/types';
import { DefaultTokens, Tokens, WebTokens } from '@aws-amplify/ui/dist/types/theme/tokens';
import { Breakpoints } from '@aws-amplify/ui/dist/types/theme/breakpoints';
export * from '@aws-amplify/ui/dist/types/theme/tokens/types/designToken';
export type { FontSizes } from '@aws-amplify/ui/dist/types/theme/tokens/fontSizes';
export type { FontWeights } from '@aws-amplify/ui/dist/types/theme/tokens/fontWeights';
export type { LineHeights } from '@aws-amplify/ui/dist/types/theme/tokens/lineHeights';
export type { Radii } from '@aws-amplify/ui/dist/types/theme/tokens/radii';
export type { Shadows } from '@aws-amplify/ui/dist/types/theme/tokens/shadows';
export type { SpaceSizes } from '@aws-amplify/ui/dist/types/theme/tokens/space';
/**

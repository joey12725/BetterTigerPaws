...
import { GetterFromEnv } from "@aws-sdk/node-config-provider/types/fromEnv";
import { GetterFromConfig, SharedConfigInit } from "@aws-sdk/node-config-provider/types/fromSharedConfigFiles";
import { FromStaticConfig } from "@aws-sdk/node-config-provider/types/fromStatic";
